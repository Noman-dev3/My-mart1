...
export default function FaqPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#f4ffe6] via-white to-white">
      <Header />
      <div className="flex-grow">
        <div className="bg-transparent">
          <div className="container mx-auto px-4 py-16 text-center">
            <HelpCircle className="mx-auto h-16 w-16 text-emerald-500" />
        ...
        <main className="container mx-auto px-4 py-12 -mt-10">
          <Card className="mx-auto max-w-4xl border border-emerald-50 bg-white/85 shadow-[0_30px_120px_rgba(60,110,60,0.2)] backdrop-blur">
