  ...
  return (
    <div className="w-full max-w-6xl mx-auto bg-gray-800 rounded-2xl shadow-2xl flex overflow-hidden">
      ...
      <div className="relative hidden lg:block lg:w-1/2">
        <Image
          src="https://picsum.photos/seed/desert-plant/800/1200"
          alt="Desert Plant"
          layout="fill"
          className="object-cover"
          data-ai-hint="desert plant"
        />
        <div className="absolute inset-0 bg-black/30 p-8 text-white flex flex-col">
            ...
            <div className="mt-auto text-center">
                ...
                <p className="mt-2 text-sm max-w-sm mx-auto opacity-90">A new way of living, a new way of being. Experience the difference with our platform.</p>
      ...
      <div className="w-full lg:w-1/2 p-8 sm:p-12">
        ...
        <p className="text-gray-400 mb-8">Let's get you started with a free account.</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
                ...
                <input
                    {...register('agreeTerms')}
                    type="checkbox"
                    className="h-4 w-4 rounded border-gray-500 bg-gray-700 text-indigo-500 focus:ring-indigo-400"
                />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
         ...
         <p className="text-sm text-gray-400 mt-8 text-center">
            ...
            <Link href="/signin" className="font-semibold text-indigo-400 hover:underline">
                Sign In
            </Link>
        </p>
