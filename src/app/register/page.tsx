...
// Updated schema to match the new form fields
...
// A placeholder SVG for the Google icon
const GoogleIcon = () => (
...
// A placeholder SVG for the Apple icon
const AppleIcon = () => (
      ...
      <div className="w-full lg:w-1/2 p-8 sm:p-12 flex flex-col bg-gradient-to-br from-white via-white to-yellow-50">
        <div className="flex-grow">
          ...
          <div className="mt-12">
            ...
            <p className="text-sm text-gray-500">Sign up and get 30 day free trial</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5">
            ...
            <div>
              ...
              <input
                {...register('email')}
                type="email"
                placeholder="ameliulaurent@gmail.com"
                className="w-full mt-2 px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button className="w-full py-3 font-semibold text-center text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2" onClick={handleGoogleSignIn} disabled={isLoading}>
              <AppleIcon />
              Apple
            </button>
        ...
        <div className="mt-8 text-xs text-gray-400 flex justify-between items-center">
            <p>Have any account? <Link href="/signin" className="font-semibold text-gray-600 hover:underline">Sign in</Link></p>
